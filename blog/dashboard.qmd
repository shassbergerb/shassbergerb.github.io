...
| **Database** | NHANES  |
| **X**     | X |
| **Timeline**    |  2017-March 2020  |

------------------------------------------------------------------------

The data presented was collected from the following NHANES databases

|Database |Participants | exlcluded | 
|--------------------------|-----|-----|
...
The data used in this analysis can be found at [the CDC National Health and Nutrition Examination Survey website](https://wwwn.cdc.gov/nchs/nhanes/continuousnhanes/default.aspx?cycle=2017-2020).
:::

# Analysis 1

```{r analysis_1, results='hide'}
